...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = _react2['default'].createClass({
	    ...
	    render: function render() {
	        ...
	        if (this.state.run) {
	            return _react2['default'].createElement('div', { style: lessonLoadingStyle, id: this.props.divPlace });
	        } else {
	            return _react2['default'].createElement('div', { style: lessonStyle, id: this.props.divPlace, dangerouslySetInnerHTML: {
