...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Karaoke = __webpack_require__(159);

	var _Karaoke2 = _interopRequireDefault(_Karaoke);

	var _SliderMenu = __webpack_require__(180);

	var _SliderMenu2 = _interopRequireDefault(_SliderMenu);
	...
	function main() {
	    _react2['default'].render(_react2['default'].createElement(_SliderMenu2['default'], null), document.getElementById('app'));
	    //    React.render(<div><Hello /><Lesson /><SliderMenu/></div>, document.getElementById('app'));
	    touchslider.createSlidePanel('#slidebar', 100, 8);
	    //    var stateObject = {};
	    //    var title = "Wow Title";
	...
	//    var parts = url.split("/");
	//    var html = parts[parts.length-1].split("?")[0];
	//    var usrid = getQueryString("userid");
	//    var Request = new Object();
	//    Request = GetRequest();
	//    var random = MathRand(16);
	//    if(getQueryString("userid")==null){
	//        var newUserid = MathRand(16);
	//        var newUrl="";
	//        newUrl = newUrl+html+"?";
	//
	...
	//
	//        }
	//        history.pushState(null,null,newUrl+"&reflowid="+"&newUserid="+newUserid);
	//    }else{
	//        var newUrl="";
	//        newUrl = newUrl+html+"?";
	//        for(var i=0;i<Request.length;i++)
	...
	//
	//        }
	//        history.pushState(null,null,newUrl+"&reflowid="+random);
	//    }
	//}
...
/***/ function(module, exports, __webpack_require__) {
	...
	//import Audio from 'react-lite-audio';

	var _KaraokeAudio = __webpack_require__(160);

	var _KaraokeAudio2 = _interopRequireDefault(_KaraokeAudio);

	var Word = _react2['default'].createClass({
	    displayName: 'Word',

	    render: function render() {
	        var ani = 'ani-h3 ' + this.props.time + 's forwards';
	        var divStyle = {
	            display: 'block',
	            fontSize: this.props.width,
	            margin: '0 auto',
	            fontFamily: 'Apple LiSung Light',
	            //            fontWeight:'16px',
	            //            fontStyle:'italic',
	            textAlign: 'center',
	            color: 'transparent',
	        ...
	        return _react2['default'].createElement(
	            'li',
	            { style: this.props.begin == "true" ? divStyle : divStyleNo },
	            this.props.value
	        );
	    }
	});
	module.exports = _react2['default'].createClass({
	    ...
	    handleStop: function handleStop(time) {

	        var self = this;
	        this.timeout = setTimeout(function () {
	            self.setState({ run: false });
	            console.log("end");
	            self.refs.audio.endPlay();
	        }, time);
	    },
	    handleClick: function handleClick(event) {
	        this._audio = this.refs.audio;

	        this.refs.audio.playClick();
	    ...
	    componentDidMount: function componentDidMount() {
	        this._audioEl = this.refs.audio._audioEl;
	        this._audioEl.addEventListener('timeupdate', this.timeupdate);
	        this.loadFromServer();
	    ...
	    render: function render() {
	        ...
	        var source;
	        source = this.props.mp3;
	        console.log(source);
	        if (this.state.data) {
	            var commentNodes = this.state.data.map(function (comment) {
	                return _react2['default'].createElement(Word, { key: comment.key, value: comment.value, begin: text, time: comment.time, delay: comment.delay, width: comment.width, height: comment.height, x: comment.x, y: comment.y });
	            });

	            return _react2['default'].createElement(
	                'div',
	                { id: 'sentence', className: 'container-fluid', onClick: this.handleClick },
	                commentNodes,
	                _react2['default'].createElement(_KaraokeAudio2['default'], { source: source, ref: 'audio' })
	            );
	        } else {
	            return _react2['default'].createElement(
	                'div',
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
	    var React, T, audio, cx, div, span;

	    React = __webpack_require__(161);

	    cx = __webpack_require__(179);
	    ...
	    module.exports = React.createClass({
	        ...
	        componentDidMount: function componentDidMount() {
	            this._audioEl = this.refs.audio.getDOMNode();
	            this._audioEl.addEventListener('durationchange', this.durationchange);
	            //            this._audioEl.addEventListener('timeupdate', this.timeupdate);
	            this._audioEl.addEventListener('loadstart', this.loadstart);
	            this._audioEl.addEventListener('progress', this.progress);
	            this._audioEl.addEventListener('waiting', this.waiting);
	            this._audioEl.addEventListener('canplaythrough', this.canplaythrough);
	            return this._audioEl.addEventListener('ended', this.ended);
	        },
	        componentWillUnmount: function componentWillUnmount() {
	            this._audioEl.removeEventListener('durationchange', this.durationchange);
	            //            this._audioEl.removeEventListener('timeupdate', this.timeupdate);
	            return this._audioEl.removeEventListener('ended', this.ended);
	        },
	        //客户端开始请求数据
	        ...
	        render: function render() {
	            var className, classNameProgress, duration, durationFormat, playPercent, progressStyle, src, timelineStyle, noneStyle;
	            ...
	            return div({
	                ...
	                ref: 'audio',
	                src: src
	            }), !this.state.played && this.props.isUnread ? div({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactTransitionGroup = React.createFactory(__webpack_require__(168));
	var ReactCSSTransitionGroupChild = React.createFactory(__webpack_require__(173));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Lesson = __webpack_require__(181);
	...
	module.exports = _react2['default'].createClass({
	    ...
	    handleClick: function handleClick(event) {
	        ...
	        //            success: function(data) {
	        //
	        ////                var htmlInput = "<div>"+data.replace(/[\r\n]/g,"").replace(/&nbsp;/ig, "")+"</div>";
	        ////                var htmlToReactParser = new HtmlToReact.Parser(React);
	        ////                var reactComponent = htmlToReactParser.parse(htmlInput);
	        ////                this.setState({data: reactComponent});
	        //
	        //                this.setState({data: data});
	        ////                $("#page01").empty();
	        ////                $("#page01").html(data);
	        ////                var karaoke = $("[karaoke='true']");
	        ////                $("[karaoke='true']").each(function(){
	        ////                    var endtime =$(this).attr("endtime");
	        ////                    var json =$(this).attr("json");
	        ////                    var mp3 = $(this).attr("mp3");
	        ////                    $(this).empty();
	        ////
	        ////                    React.render(<div style={{height:'60px',textDecoration: 'underline'}}><Sentence url={json} endTime={endtime} mp3={mp3}/></div>, this);
	        ////                });
	        ////
	        ////                console.log(karaoke);
	        //            }.bind(this),
	    ...
	    render: function render() {
	        ...
	        return _react2['default'].createElement(
	            'div',
	            null,
	            _react2['default'].createElement(_Lesson2['default'], { id: 'p1', url: this.state.lesson != null ? this.state.lesson : "http://lmsreader.herokuapp.com/api/html?path=lesson1/P2LESSON1_1/P2LESSON1_1.htm&hostPath=http://lmsreader.herokuapp.com/api/html?path=lesson1/P2LESSON1_1/", divPlace: 'page01' }),
	            _react2['default'].createElement(
	                ...
	                _react2['default'].createElement(
	                    ...
	                    _react2['default'].createElement(
	                        'div',
	                        { className: 'cell', id: 'maintitle', style: divStyle, onClick: this.handleClick.bind(this, "http://lmsreader.herokuapp.com/api/html?path=lesson1/P2LESSON1_1/P2LESSON1_1.htm&hostPath=http://lmsreader.herokuapp.com/api/html?path=lesson1/P2LESSON1_1/") },
	                        _react2['default'].createElement('img', { src: 'http://lmsreader.herokuapp.com/api/image?path=lesson1/P2LESSON1_1/image.jpg', style: imgStyle, lesson: 'http://lmsreader.herokuapp.com/api/html?path=lesson1/P2LESSON1_1/P2LESSON1_1.htm' })
	                    ),
	                    _react2['default'].createElement(
	                        'div',
	                        { className: 'cell', style: divStyle, onClick: this.handleClick.bind(this, "http://lmsreader.herokuapp.com/api/html?path=lesson1/P2LESSON1_2/P2LESSON1_2.htm&hostPath=http://lmsreader.herokuapp.com/api/html?path=lesson1/P2LESSON1_2/") },
	                        _react2['default'].createElement('img', { src: 'http://lmsreader.herokuapp.com/api/image?path=lesson1/P2LESSON1_2/image.jpg', style: imgStyle, lesson: 'http://lmsreader.herokuapp.com/api/html?path=lesson1/P2LESSON1_2/P2LESSON1_2.htm' })
	                    ),
	                    _react2['default'].createElement(
	                        'div',
	                        { className: 'cell', style: divStyle, onClick: this.handleClick.bind(this, "http://lmsreader.herokuapp.com/api/html?path=lesson1/P2LESSON1_3/P2LESSON1_3.htm&hostPath=http://lmsreader.herokuapp.com/api/html?path=lesson1/P2LESSON1_3/") },
	                        _react2['default'].createElement('img', { src: 'http://lmsreader.herokuapp.com/api/image?path=lesson1/P2LESSON1_3/image.jpg', style: imgStyle, lesson: 'http://lmsreader.herokuapp.com/api/html?path=lesson1/P2LESSON1_3/P2LESSON1_3.htm' })
	                    ),
	                    _react2['default'].createElement(
	                        'div',
	                        { className: 'cell', style: divStyle, onClick: this.handleClick.bind(this, "http://lmsreader.herokuapp.com/api/html?path=lesson1/P2LESSON1_4/P2LESSON1_4.htm&hostPath=http://lmsreader.herokuapp.com/api/html?path=lesson1/P2LESSON1_4/") },
	                        _react2['default'].createElement('img', { src: 'http://lmsreader.herokuapp.com/api/image?path=lesson1/P2LESSON1_4/image.jpg', style: imgStyle, lesson: 'http://lmsreader.herokuapp.com/api/html?path=lesson1/P2LESSON1_4/P2LESSON1_4.htm' })
	                    ),
	                    _react2['default'].createElement(
	                        'div',
	                        { className: 'cell', style: divStyle, onClick: this.handleClick.bind(this, "http://lmsreader.herokuapp.com/api/html?path=lesson1/P2LESSON1_5/P2LESSON1_5.htm&hostPath=http://lmsreader.herokuapp.com/api/html?path=lesson1/P2LESSON1_5/") },
	                        _react2['default'].createElement('img', { src: 'http://lmsreader.herokuapp.com/api/image?path=lesson1/P2LESSON1_5/image.jpg', style: imgStyle, lesson: 'http://lmsreader.herokuapp.com/api/html?path=lesson1/P2LESSON1_5/P2LESSON1_5.htm' })
	                    )
	                )
	            ),
	            _react2['default'].createElement(
	                'div',
	                { id: 'controls-wrapper', className: 'load-item' },
	                _react2['default'].createElement(
	                    'div',
	                    { id: 'controls' },
	                    _react2['default'].createElement(
	                        'a',
	                        { id: 'play-button' },
	                        _react2['default'].createElement('img', { id: 'pauseplay', src: 'img/pause.png' })
	                    ),
	                    _react2['default'].createElement(
	                        'div',
	                        { id: 'slidecounter' },
	                        _react2['default'].createElement('span', { className: 'slidenumber' }),
	                        ' / ',
	                        _react2['default'].createElement('span', { className: 'totalslides' })
	                    ),
	                    _react2['default'].createElement('div', { id: 'slidecaption' }),
	                    _react2['default'].createElement(
	                        'a',
	                        { id: 'tray-button' },
	                        _react2['default'].createElement('img', { id: 'tray-arrow', src: 'img/button-tray-up.png' })
	                    ),
	                    _react2['default'].createElement('ul', { id: 'slide-list' })
	                )
	            )
	        );
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = _react2['default'].createClass({
	    ...
	    loadFromServer: function loadFromServer(url) {
	        ...
	        $.ajax({
	            ...
	            success: (function (data) {
	                ...
	                //                $("#"+this.props.divPlace).empty();
	                //                $("#"+this.props.divPlace).html(htmlInput);
	                //                var karaoke = $("[karaoke='true']");
	                //                $("[karaoke='true']").each(function(){
	                //                    var endtime =$(this).attr("endtime");
	                //                    var json =$(this).attr("json");
	    ...
	    render: function render() {
	        ...
	        var lessonLoadingStyle = {
	            marginBottom: 300,
	            background: '#111 url(./img/progress.gif) no-repeat center top'
	        };
	        var lessonStyle = {
	            marginBottom: 300
	        };
	        //        console.log(this.state.run);
	        return _react2['default'].createElement('div', { style: !this.state.run ? lessonStyle : lessonLoadingStyle, id: this.props.divPlace, dangerouslySetInnerHTML: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../node_modules/css-loader/index.js!./../node_modules/less-loader/index.js!./touchslider.less", function() {
				var newContent = require("!!./../node_modules/css-loader/index.js!./../node_modules/less-loader/index.js!./touchslider.less");
...
/***/ function(module, exports) {
	...
	module.exports = "data:image/png;base64,"
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".lite-audio {\n  display: inline-block;\n}\n.lite-audio audio {\n  display: none;\n  visibility: hidden;\n}\n.lite-audio .audio-player {\n  position: relative;\n  display: inline-block;\n  max-width: 200px;\n  min-width: 100px;\n  height: 36px;\n  border-radius: 5px;\n  cursor: pointer;\n  color: #1975d2;\n  background-color: rgba(25, 117, 210, 0.1);\n  vertical-align: middle;\n}\n.lite-audio .content {\n  display: -moz-box;\n  display: -webkit-box;\n  display: -webkit-flex;\n  display: -ms-flexbox;\n  display: -ms-flex;\n  display: flex;\n  -webkit-box-orient: horizontal;\n  -moz-box-orient: horizontal;\n  -webkit-box-direction: normal;\n  -moz-box-direction: normal;\n  min-width: 0;\n  -webkit-flex-direction: row;\n  -moz-flex-direction: row;\n  -ms-flex-direction: row;\n  flex-direction: row;\n  -webkit-box-pack: justify;\n  -moz-box-pack: justify;\n  -ms-flex-pack: justify;\n  -webkit-justify-content: space-between;\n  -moz-justify-content: space-between;\n  -ms-justify-content: space-between;\n  justify-content: space-between;\n  -webkit-box-align: center;\n  -moz-box-align: center;\n  -ms-flex-align: center;\n  -webkit-align-items: center;\n  -moz-align-items: center;\n  -ms-align-items: center;\n  align-items: center;\n  padding-left: 8px;\n  padding-right: 15px;\n}\n.lite-audio .audio-player .progress {\n  height: 36px;\n  position: absolute;\n  top: 0;\n  border-top-left-radius: 5px;\n  border-bottom-left-radius: 5px;\n  background-color: rgba(25, 117, 210, 0.2);\n}\n.lite-audio .audio-player .progress.is-playing {\n  transition: width 200ms linear;\n  -webkit-transition: width 200ms linear;\n  -moz-transition: width 200ms linear;\n}\n.lite-audio .audio-player .icon {\n  font-size: 20px;\n  line-height: 36px;\n}\n.lite-audio .audio-player .time {\n  line-height: 36px;\n}\n.lite-audio .unread-dot {\n  display: inline-block;\n  width: 10px;\n  height: 10px;\n  margin: 0px 0 0px 10px;\n  border-radius: 50%;\n  background-color: #ff6e42;\n}\n.lite-audio.slim .audio-player {\n  background-color: #fff;\n}\n.lite-audio.slim .content {\n  padding: 0;\n  -webkit-box-pack: start;\n  -moz-box-pack: start;\n  -ms-flex-pack: start;\n  -webkit-justify-content: flex-start;\n  -moz-justify-content: flex-start;\n  -ms-justify-content: flex-start;\n  justify-content: flex-start;\n}\n.lite-audio.slim .audio-player .icon + .time {\n  margin-left: 10px;\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "a234740516d945d70f76292c7635438a.jpg"

/***/ },
/* 192 */
/***/ function(module, exports) {

	module.exports = "data:image/png;base64,"

/***/ },
/* 193 */
/***/ function(module, exports) {

	module.exports = "data:image/png;base64,"

/***/ },
/* 194 */
/***/ function(module, exports) {

	module.exports = "data:image/png;base64,"
...
/***/ function(module, exports) {
	...
	module.exports = "data:image/png;base64,"
